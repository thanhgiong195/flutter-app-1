...
import 'package:nobest_tag_app/item_detail_screen.dart';
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          if (filterList[1].isSelected)
                                            item(filterList[1].titleTxt,
                                                foods[index].title),
                                          if (filterList[2].isSelected)
                                            item(filterList[2].titleTxt,
                                                '¥' + foods[index].price),
                                          if (filterList[3].isSelected)
                                            item(filterList[3].titleTxt,
                                                foods[index].sku),
                                          if (filterList[4].isSelected)
                                            item(filterList[4].titleTxt,
                                                foods[index].description),
                                          if (filterList[5].isSelected)
                                            item(filterList[5].titleTxt,
              ...
              child: InkWell(
                ...
                child: Padding(
                  ...
                  child: Icon(FontAwesomeIcons.magnifyingGlass,
                      size: 20, color: AppTheme.nearlyWhite),
                ),
              ),
            ),
          ),
